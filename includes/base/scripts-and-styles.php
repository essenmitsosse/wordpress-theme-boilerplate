...
function add_style_and_script() {
	...
	// STYLES
	wp_enqueue_style( 'theme-style',  get_stylesheet_directory_uri() . '/style' . $file_extension . '.css');
	...
	// FOOTER SCRIPTS
	wp_enqueue_script( 'jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery' . $file_extension . '.js', false, '2.1.4', true );
	wp_enqueue_script( 'theme-script', get_stylesheet_directory_uri() . '/assets/js/main' . $file_extension . '.js', array( 'jquery' ), '0.1.0', true );
